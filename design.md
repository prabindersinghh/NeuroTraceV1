...
|---|---|---|
| Session promise | “Three minutes a day” | “Ninety seconds a day” |
| HTML title | “a ~3-minute neurological exam” | “a 90-second neurological exam” |
| Hero safety lead-in | Emergency caveat only | Adds “A monitoring aid, not a medical device” |
| Footer | `engine deterministic · seed 42` | Adds `not a medical device` |
