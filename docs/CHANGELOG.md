...
## 2026-09-03 (latest) — `main` merged into `feat/journey-experience`, ahead of the PR
...
in one file and said nothing. This branch's renumbered to **D-078** and **D-079** before the
...
D-078 widened `hardcodedStrings.test.ts` from the exam path to `routes/**` plus
