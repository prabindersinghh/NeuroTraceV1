...
| 13 | Awaaz D1–D5 complete | **PARTIAL** | Board, INV-9 confirmation, listener capability, consented local card/audio pairs, 0.5–4.0 s endpointing, text review, and a caregiver-recorded/self-tested offline emergency WAV exist. Missing: patient-speech ASR, reviewed-speech audio, adapter training/deployment, and caregiver notification provider |
...
| 19 | All invariants pinned; suite green by exit code | **TEST** | 12 invariants; full backend run on 2026-08-28: 886 collected / 883 passed / 3 skipped / 0 failed |
