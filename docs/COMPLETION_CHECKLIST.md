...
| 13 | Awaaz D1–D5 complete | **PARTIAL** | Board, INV-9 confirmation, listener capability, consented local card/audio pairs, 0.5–4.0 s endpointing, text review, offline emergency WAV, long-press, opt-in location, and a configured-only SMTP adapter exist. Missing: patient-speech ASR, reviewed-speech audio, adapter training/deployment, provider credentials/field test, and one-tap calling |
...
| 19 | All invariants pinned; suite green by exit code | **TEST** | 12 invariants; full backend run on 2026-08-28: 892 collected / 889 passed / 3 skipped / 0 failed |
