...
const buttonVariants = cva(
  ...
  "tactile inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-medium focus-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
