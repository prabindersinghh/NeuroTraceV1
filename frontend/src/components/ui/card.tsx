 ...
 * docs/archive/UX-CHANGES.md rather than swept here, because changing it is a restyle, not a fix.
 */
interface CardProps extends HTMLAttributes<HTMLDivElement> {
  /**
   * The card is itself a control — a row you open, a tile you tap.
   *
   * docs/DESIGN_LANGUAGE.md §3 gives interactive cards `tactile-lift`. The reference lifts them
